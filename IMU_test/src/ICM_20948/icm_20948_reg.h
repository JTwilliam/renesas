#ifndef __ICM20948_REG_H
#define __ICM20948_REG_H
...
// Bank0 寄存器定义
#define WHO_AM_I 0x00 // 读取该寄存器值,返回0xEA
...
// 磁力计设备地址
#define AK09916_DEV 0x0C // 磁力计设备地址
#define WIA 0x01         // who am i寄存器,返回值 0x09
#define ST1 0x10
#define HXL 0x11
#define HXH 0x12
#define HYL 0x13
